...
-- ----------------------------
-- Table structure for mes_tenant
-- ----------------------------
drop table if exists mes_tenant;
create table mes_tenant
(
...
-- ----------------------------
-- Table structure for mes_user_login
-- ----------------------------
drop table if exists mes_user_login;
...
-- ----------------------------
-- Table structure for mes_user_password
-- ----------------------------
drop table if exists mes_user_password;
create table mes_user_password
(
    id             bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_tenant_bind
-- ----------------------------
drop table if exists mes_tenant_bind;
create table mes_tenant_bind
(
    id            bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_driver
-- ----------------------------
drop table if exists mes_driver;
create table mes_driver
(
    id               bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_driver_attribute
-- ----------------------------
drop table if exists mes_driver_attribute;
create table mes_driver_attribute
(
    id                  bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_point_attribute
-- ----------------------------
drop table if exists mes_point_attribute;
create table mes_point_attribute
(
    id                  bigint unsigned auto_increment primary key                               not null comment '主键ID',
    display_name        varchar(128) default ''                                                  not null comment '显示名称',
    attribute_name      varchar(128) default ''                                                  not null comment '属性名称',
...
-- ----------------------------
-- Table structure for mes_profile
-- ----------------------------
drop table if exists mes_profile;
create table mes_profile
(
    id                 bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_point
-- ----------------------------
drop table if exists mes_point;
create table mes_point
(
    id                       bigint unsigned auto_increment primary key                                 not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_device
-- ----------------------------
...
-- ----------------------------
-- Table structure for mes_profile_bind
-- ----------------------------
drop table if exists mes_profile_bind;
create table mes_profile_bind
(
    id            bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_driver_attribute_config
-- ----------------------------
drop table if exists mes_driver_attribute_config;
create table mes_driver_attribute_config
(
    id                  bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_point_attribute_config
-- ----------------------------
drop table if exists mes_point_attribute_config;
create table mes_point_attribute_config
(
    id                 bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_alarm_notify_profile
-- ----------------------------
drop table if exists mes_alarm_notify_profile;
create table mes_alarm_notify_profile
(
    id                bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_alarm_message_profile
-- ----------------------------
drop table if exists mes_alarm_message_profile;
create table mes_alarm_message_profile
(
    id                bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_alarm_rule
-- ----------------------------
drop table if exists mes_alarm_rule;
create table mes_alarm_rule
(
    id              bigint unsigned auto_increment primary key                               not null comment '主键ID',
    point_id        bigint       default 0                                                   not null comment '位号ID',
...
-- ----------------------------
-- Table structure for mes_role_user_bind
-- ----------------------------
drop table if exists mes_role_user_bind;
create table mes_role_user_bind
(
    id            bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_role_resource_bind
-- ----------------------------
drop table if exists mes_role_resource_bind;
create table mes_role_resource_bind
(
    id            bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_api
-- ----------------------------
drop table if exists mes_api;
create table mes_api
(
    id            bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_label
-- ----------------------------
drop table if exists mes_label;
create table mes_label
(
    id               bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_label_bind
-- ----------------------------
drop table if exists mes_label_bind;
create table mes_label_bind
(
    id            bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_group
-- ----------------------------
drop table if exists mes_group;
create table mes_group
(
    id              bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Table structure for mes_black_ip
-- ----------------------------
drop table if exists mes_black_ip;
create table mes_black_ip
(
    id            bigint unsigned auto_increment primary key                               not null comment '主键ID',
...
-- ----------------------------
-- Records of mes_tenant
-- ----------------------------
INSERT INTO mes_tenant
VALUES (1, '', 'default', 1, '租户', 0, 'mes', '2016-10-01 00:00:00', 0, 'mes', '2016-10-01 00:00:00', 0);

-- ----------------------------
-- Records of mes_user_login
-- ----------------------------
INSERT INTO mes_user_login
VALUES (1, 'pnoker', 1, 1, 1, '用户', 0, 'mes', '2016-10-01 00:00:00', 0, 'mes', '2016-10-01 00:00:00', 0);
...
-- password: mes
-- ----------------------------
INSERT INTO mes_user_password
VALUES (1, '10e339be1130a90dc1b9ff0332abced6', '用户密码', 0, 'mes', '2016-10-01 00:00:00', 0, 'mes',
...
VALUES (1, '张红元', 'pnoker', '18304071393', 'pnokers@icloud.com', '{}', '{}', '用户信息', 0, 'mes',
        '2016-10-01 00:00:00', 0, 'mes', '2016-10-01 00:00:00', 0);

-- ----------------------------
-- Records of mes_tenant_bind
-- ----------------------------
INSERT INTO mes_tenant_bind
VALUES (1, 1, 1, '租户,用户关联', 0, 'mes', '2016-10-01 00:00:00', 0, 'mes', '2016-10-01 00:00:00', 0);
