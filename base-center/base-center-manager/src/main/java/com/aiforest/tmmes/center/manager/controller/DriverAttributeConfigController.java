...
public class DriverAttributeConfigController {
    ...
    @PostMapping("/update_or_add")
    public R<String> updateOrAdd(@Validated(Update.class) @RequestBody DriverAttributeConfig driverAttributeConfig) {
        try {
            driverAttributeConfigService.updateOrAdd(driverAttributeConfig);
            return R.ok();
        } catch (Exception e) {
            return R.fail(e.getMessage());
        }
