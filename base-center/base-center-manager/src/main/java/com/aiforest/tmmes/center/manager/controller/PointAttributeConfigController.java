...
public class PointAttributeConfigController {
    ...
    public R<String> updateOrAdd(@Validated(Update.class) @RequestBody PointAttributeConfig pointAttributeConfig) {
        try {
            pointAttributeConfigService.updateOrAdd(pointAttributeConfig);
            return R.ok();
        } catch (Exception e) {
            return R.fail(e.getMessage());
        }
