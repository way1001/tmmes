...
import com.aiforest.tmmes.center.manager.entity.query.DriverAttributeConfigPageQuery;
import com.aiforest.tmmes.center.manager.mapper.DriverAttributeConfigMapper;
import com.aiforest.tmmes.center.manager.mapper.DriverAttributeMapper;
import com.aiforest.tmmes.center.manager.service.DriverAttributeConfigService;
import com.aiforest.tmmes.center.manager.service.NotifyService;
...
import com.aiforest.tmmes.common.model.DriverAttributeConfig;
...
public class DriverAttributeConfigServiceImpl implements DriverAttributeConfigService {
    ...
    @Override
    public void updateOrAdd(DriverAttributeConfig entityDO){
        try {
            DriverAttributeConfig driverAttributeConfig = selectByDeviceIdAndAttributeId(entityDO.getDeviceId(), entityDO.getDriverAttributeId());
            driverAttributeConfig.setOperateTime(null);
            driverAttributeConfig.setConfigValue(entityDO.getConfigValue());
            if (driverAttributeConfigMapper.updateById(driverAttributeConfig) < 1) {
                throw new UpdateException("The driver attribute config update failed");
            }
