...
import com.aiforest.tmmes.center.auth.service.impl.UserServiceImpl;
import com.aiforest.tmmes.common.model.User;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.aiforest.tmmes.center.auth.entity.query.UserLoginPageQuery;
...
public class UserLoginController {
    ...
    public R<User> selectByLoginName(@NotNull @PathVariable(value = "name") String name) {
        try {
            User select = userService.selectByUserName(name, false);
            if (ObjectUtil.isNotNull(select)) {
                return R.ok(select);
            }
        } catch (Exception e) {
