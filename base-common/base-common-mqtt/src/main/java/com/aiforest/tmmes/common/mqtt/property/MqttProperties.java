...
package com.aiforest.tmmes.common.mqtt.property;
...
public class MqttProperties {
    ...
    private String clientKeyPass = "tmmes-client";
    ...
    private Topic defaultSendTopic = new Topic("tmmes/d/v/tmmes-driver-mqtt_default", 2);
